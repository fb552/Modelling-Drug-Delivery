...
elemat = LEMdiffusion(eN,msh,GQ,order);
...
elemat1 = LEMdiffusion(eN,msh,GQ,order);

eN=2;

elemat2 = LEMdiffusion(eN,msh,GQ,order);
...
GQ.npts = 2;
order = 1;
msh = OneDimLinearMeshGen(0,1,3,order,parameters);
...
% % Test that the element matrix is evaluated correctly using Gaussian
% % Quadrature
tol = 1e-14;
eN=1;
parameters.selection = '1';
